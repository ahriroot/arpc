# -*- coding: utf-8 -*-
# Generated by arpc-python at Wed Nov 23 22:10:33 2022
...
class Arpc(metaclass=abc.ABCMeta):
    ...
    async def register(self, server):
        await server.register('arpc2.0', await get_func(self.get_user_v1))
        await server.register('arpc2.1', await get_func(self.post_user_v1))
